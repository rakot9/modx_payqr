...
payqr is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/payqr.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory payqr is now in, and do this:
...
Now, you'll want to change references to payqr in the files in your
new copied-from-payqr repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'payqr' to whatever the
name of your component is.

## Copyright Information

payqr is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of payqr the ability to modify, distribute
and use payqr in MODx development as they see fit, as long as attribution
